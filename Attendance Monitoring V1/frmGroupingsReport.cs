...
namespace AMS
{
    public partial class frmGroupingsReport : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        DataTable dtGroupings = new DataTable();
        XtraReportGroupings groupingsReport = new XtraReportGroupings();

        public frmGroupingsReport()
        {
            InitializeComponent();
        }
        ...
        private void barButtonGenerate_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    SetHeaders();
                    groupingsReport.xrLabelGroupServant.Text = dtGroupings.Rows[0]["Group_servant"].ToString();
                    groupingsReport.xrLabelAsstGroupServant.Text = dtGroupings.Rows[0]["Asst_servant"].ToString();
